    ...
    return (
        <>
            <div className="services-single-content">
                <div className="thumb">
                    <Image src="/assets/img/banner/5.jpg" alt="Thumb" width={1032} height={585} />
                </div>
                    ...
                    <div className="row">
                        <div className="col-md-6">
                            <div className="item">
                                ...
                                <h4><Link href="#" scroll={false}>Speed Optimization</Link></h4>
                                <p>
                        ...
                        <div className="col-md-6">
                            <div className="item">
                                ...
                                <h4><Link href="#" scroll={false}>Frontend Development</Link></h4>
                                <p>
                                    These cases are perfectly simple and easy to distinguish. In a free hour, when our power.
                                </p>
                            </div>
